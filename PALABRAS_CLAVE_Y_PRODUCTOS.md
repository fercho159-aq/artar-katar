# Astar Katar - Palabras Clave y Productos

## 1. PALABRAS CLAVE SEO

### Metadata Principal del Sitio
- **Título:** Astar Katar
- **Descripción:** Portal Multidimensional de Astar Katar por Frank Alexander

### Palabras Clave por Categoría de Filtrado (Tienda)

| Categoría | Palabras Clave |
|-----------|----------------|
| Kundalini | `kundalini`, `sexualidad` |
| Intelecto | `einstein`, `intelecto` |
| Abundancia | `abundancia`, `millonario`, `adn` |
| Propósito | `dones`, `propósito`, `alma` |
| Sanación | `sanador`, `sanación` |
| Protección | `protección`, `anclas` |

### Palabras Clave Conceptuales del Sitio

- Portal multidimensional
...
### Entidades Cósmicas Mencionadas (Keywords)
...
### Redes Sociales
- Instagram: @portalviviente
- YouTube: @astarkatar-portalviviente
- Facebook: portal.viviente, portal.cristico.de.luz
- TikTok: @portal_viviente0
...
| **Categoría** | Intelecto |
| **Descripción Corta** | Potencia tu capacidad intelectual y cognitiva con energía cuántica Omega |
| **Activado Por** | Arcturianos de 9ª densidad |

**Beneficios:**
- Mejora tu capacidad intelectual y cognitiva
- Ayuda en pensamiento abstracto
- Permite un enfoque nuevo a problemas que trasciendan la lógica ordinaria
- Cargada con energía cuántica Omega
- Ideal para ejecutivos, profesionales con alta exigencia mental y estudiantes
...
### B. MEDITACIONES (Productos Digitales)

| ID | Título | Duración | Precio |
|----|--------|----------|--------|
| med_test_001 | Meditación de Prueba | 1 min | $1.00 MXN |
| med_001 | Meditación de Anclaje a Tierra | 15 min | $40.00 MXN |
| med_002 | Activación del Corazón Cristalino | 25 min | $40.00 MXN |
| med_003 | Viaje al Templo de Sanación | 30 min | $40.00 MXN |
| med_004 | Limpieza Energética Profunda | 20 min | $40.00 MXN |
| med_005 | Conexión con tu Llama Gemela | 22 min | $40.00 MXN |
| med_006 | Activación del ADN Cósmico | 33 min | $40.00 MXN |

**Descripciones:**
- **Anclaje a Tierra:** Conecta con la energía de Gaia y encuentra tu centro
- **Corazón Cristalino:** Abre tu corazón a la frecuencia del amor incondicional
- **Templo de Sanación:** Recibe sanación y guía de los maestros ascendidos
- **Limpieza Energética:** Libera energías densas y revitaliza tu campo áurico
- **Llama Gemela:** Armoniza la energía sagrada masculina y femenina en tu interior
- **ADN Cósmico:** Despierta tu potencial dormido y activa tus hebras de ADN

### Suscripción de Meditaciones
| Campo | Valor |
|-------|-------|
| **ID** | sub_001 |
| **Nombre** | Suscripción Mensual - Acceso Total |
| **Precio** | $300.00 MXN/mes |
| **Descripción** | Disfruta de todas las meditaciones existentes y futuras. Medita sin límites. |

---

### C. TALLERES (Productos Experienciales)

Los talleres se almacenan en la base de datos y se gestionan dinámicamente.

**Estructura de datos:**
- Tipo: WORKSHOP
- Estados: Abierto, Próximamente, Cerrado
- Campos: nombre, descripción, precio, precio_pareja, fecha, estado, imagen, activado_por, piedra, categoría
...
### Meditaciones
- Precio individual: $40.00 MXN
- Suscripción mensual: $300.00 MXN
...
| Tipo | Descripción |
|------|-------------|
| PHYSICAL_GOOD | Productos físicos (pulseras, anclas) - Requieren envío |
| MEDITATION | Productos digitales (meditaciones) - Descarga inmediata |
| WORKSHOP | Talleres y experiencias - Fechas programadas |

---

*Documento generado automáticamente - Astar Katar*
